...
if __name__ == '__main__': 
    ...
    print("开始训练： ")
    # # # 训练模型
    results = model.train(data='data.yaml',epochs=100,patience=15,imgsz=640, device = 0, optimizer='SGD', workers=8, batch=64, amp=False, iou = 0.5)
    ...
    #     'optimizer': 'Adam',        # 优化器，默认值 'auto'，支持 'SGD', 'Adam', 'AdamW'
    ...
    #     'degrees': 0,               # 旋转角度范围 (-180 - 180)，默认值 0.0
    ...
    #     'mosaic': 1,                # Mosaic 数据增强 (0.0 - 1.0)，默认值 1.0
